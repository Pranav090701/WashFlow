...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({CarNotFoundException.class, ProfileNotFoundException.class, ResourceNotFoundException.class})
    ...
    @ExceptionHandler({CarOwnershipMismatchException.class, AccessDeniedException.class})
