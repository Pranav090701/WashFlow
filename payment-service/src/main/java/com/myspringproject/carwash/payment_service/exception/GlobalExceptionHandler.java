...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({PaymentAccessDeniedException.class, AccessDeniedException.class})
    public ResponseEntity<ApiError> handleForbidden(RuntimeException ex, HttpServletRequest request) {
        return error(HttpStatus.FORBIDDEN, ex.getMessage(), request);
    }

    @ExceptionHandler(PaymentSlotUnavailableException.class)
    ...
    public ResponseEntity<ApiError> handleBadGateway(RuntimeException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiError> handleInvalidRequest(Exception ex, HttpServletRequest request) {
        if (ex instanceof MethodArgumentNotValidException validationException) {
            ...
            ApiError body = ApiError.withFieldErrors(HttpStatus.BAD_REQUEST.value(),
